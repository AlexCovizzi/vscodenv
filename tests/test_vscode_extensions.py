...
class TestVscodeExtensions(unittest.TestCase):
    ...
    def test_get_extensions_should_return_installed_extensions(self):
        ...
        self.assertEqual(ret, self.installed_extensions)
    ...
    def test_get_uninstalled_extensions(self):
        ...
        self.assertEqual(ret, self.uninstalled_extensions)
    ...
    def test_remove_extension_from_uninstalled_should_remove_extension_from_dot_obsolete(self):
        ...
        self.assertEqual(ret, true_uninstalled_extensions)
    ...
    def tearDown(self):
        ...
        os.remove(os.path.join(self.extensions_dir, '.obsolete'))
        os.rmdir(self.extensions_dir)
